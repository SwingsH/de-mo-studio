...
if($notice_A){
	...
	$notice = $NT_A['url'] ? "<a href=\"$NT_A[url]\">$NT_A[subject]($NT_A[startdate])</a>" : "<a href=\"notice.php?fid=$NT_A[fid]#$NT_A[aid]\">$NT_A[subject]($NT_A[startdate])</a>";
}else{
	$notice='';
}
...
//print get_date($plantime,'Y-m-d H:i');
