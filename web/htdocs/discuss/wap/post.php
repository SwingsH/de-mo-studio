...
if($action=='new'){
	...
	if(!$_POST['content']){
		...
		$db->update("INSERT INTO pw_posts(tid,fid,ifcheck,subject,author,authorid,postdate,userip,ipfrom,content) VALUES('$tid','$tp[fid]','1','$subject','$windid','$winduid','$timestamp','$onlineip','$ipfrom','$content')");
