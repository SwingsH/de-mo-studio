...
INSERT INTO pw_styles VALUES (2, 'new3', 'new3', 'new3', 'no', '#CCCCCC', '98%', '98%', '#FFFFFF', '#F7F8F8', '#FFFFFF', '#F7F8F8', '#FFFFFF', '#F7F8F8', '#FFFFFF');
INSERT INTO pw_styles VALUES (3, 'new5', 'new5', 'new5', 'no', '#9CC2D8', '98%', '98%', '#FFFFFF', '#F7F8F8', '#FFFFFF', '#F4F9FB', '#FFFFFF', '#F7F8F8', '#FFFFFF');
...
DROP TABLE IF EXISTS pw_cknum;
CREATE TABLE pw_cknum (
...
DROP TABLE IF EXISTS pw_adbbs;
CREATE TABLE pw_adbbs (
  id mediumint(8) unsigned NOT NULL auto_increment,
  adval mediumint(8) unsigned NOT NULL default '0',
