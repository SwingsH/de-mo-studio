...
function updatecache_w(){
	...
	while(@extract(db_cv($db->fetch_array($query)))){
		if($word){
			...
			$wordreplace = str_replace('\\','\\\\',$wordreplace);
			if($type==0){
...
function cache_read(){
	...
	if(!defined('CT')){
		define('CT',1);
		$readdb  = updatecache_f(1)."\r\n\r\n";
		$readdb .= updatecache_md(1)."\r\n\r\n";
		$readdb .= updatecache_l(1)."\r\n\r\n";
		$readdb .= updatecache_cr(1)."\r\n\r\n";
		$readdb .= updatecache_gr(1)."\r\n\r\n";
		$readdb .= updatecache_field(1)."\r\n\r\n";
		$readdb .= updatecache_mddb(1)."\r\n\r\n";
