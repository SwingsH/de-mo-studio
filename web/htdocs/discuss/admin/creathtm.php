...
if(!$action){
	...
	$creatadd .= " AND t.ifreward=0 AND t.activeid=0";
	$query=$db->query("SELECT t.* $S_sql $fieldadd FROM pw_threads t $J_sql $tablaadd $creatadd ORDER BY topped DESC, lastpost DESC LIMIT $start,$percount");
	unset($creatadd);
