...
$query=$db->query("SELECT t.tid,t.authorid,t.subject,t.postdate,f.fid,f.name FROM pw_threads t LEFT JOIN pw_forums f USING(fid) WHERE $timestamp-t.postdate>f.allowreward*86400 AND t.ifreward='1' AND f.allowreward>0 ORDER BY t.postdate ASC LIMIT 100");
$tids=$uiddb=array();
