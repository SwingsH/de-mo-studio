...
$pages=numofpage($count,$page,$numofpage,"read.php?tid=$tid&fpage=$fpage&toread=$toread&");//ÎÄÕÂÊý,Ò³Âë,¹²¼¸Ò³,Â·¾¶
...
$db_bbsname_a=addslashes($db_bbsname);//Ä£°æÄÚÓÃµ½
...
if($read['replies']>0){
	...
	$order="postdate";
	$rewardtype=='2' && $order="ifreward DESC,".$order; /**** ÐüÉÍ ****/
