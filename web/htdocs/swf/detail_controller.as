...
function nextOnRelease(){
	...
	var total_photo :Number = ctl_mcs.length ;
	...
	//ini interval variables
	 ctl_itvl_distance = total_photo - ctl_page_num  + 5;//13;
...
function previousOnRelease(){
	...
	//ini interval variables
	 ctl_itvl_distance = ctl_page_num - ctl_mcs.length - 5;//-13;
	 trace(  ctl_itvl_distance );
	 //trace( ctl_itvl_distance);
	 ctl_itvl_dec = -0.3 ;
