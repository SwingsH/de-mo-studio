/***********************************
*		detail_browser_bar.as
* 		(C) Swings @ DE-MO.com.tw
************************************/
// describe the default/minimize width , and height
var width_def : Number = 250 ; // just reference //參考用,參數無用
var height_def : Number = 400 ; // just reference //參考用,參數無用
var width_min : Number = 40 ; // the mini pic size
var height_min : Number = 64 ; // the mini pic size
var itvl_width :Number = 5.1 ; // the mini pic interval width
